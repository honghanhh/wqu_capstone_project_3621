...
python bayesian.py  --train_data '../data/discretized_data/train_data.csv' --val_data '../data/discretized_data/validation_data.csv' --test_data '../data/discretized_data/test_data.csv' 
python markov.py  --cleaned_data '../data/cleaned_data/test_data.csv' --hmm_data '../data/discretized_data/test_data.csv' 
python eval.py 
